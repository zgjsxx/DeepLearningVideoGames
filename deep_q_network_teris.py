...
def trainNetwork(s, readout, h_fc1, sess):
    ...
    checkpoint = tf.train.get_checkpoint_state("saved_teris_networks")
    ...
    while "pigs" != "fly":
        ...
        if t % 10000 == 0:
            saver.save(sess, 'saved_teris_networks/' + GAME + '-dqn', global_step=t)
        ...
        if t <= OBSERVE:
            ...
            state = "train"
        # print("TIMESTEP", t, "/ STATE", state, "/ LINES", game_state.total_lines, "/ EPSILON", epsilon, "/ ACTION",
